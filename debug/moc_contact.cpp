...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_Contact_t, stringdata) + ofs \
...
QT_MOC_LITERAL(4, 30, 14)
    ...
    "Contact\0litem0Slot\0\0tableProc\0"
    "addContactSlot\0"
};
...
void Contact::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->litem0Slot(); break;
        case 1: _t->tableProc(); break;
        case 2: _t->addContactSlot(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
const QMetaObject Contact::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_Contact.data,
      qt_meta_data_Contact,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Contact.stringdata))
